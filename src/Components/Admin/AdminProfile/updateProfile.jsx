...
function UserProfile() {
  ...
  const [alergy, setAlergy] = useState(user?.alergy);
  const [cardiac, setCardiac] = useState(user?.cardiac);
  const [bleeding, setBleeding] = useState(user?.bleeding);
  ...
  useEffect(() => {
    ...
    setAlergy(user?.alergy);
    setCardiac(user?.cardiac);
    setBleeding(user?.bleeding);
            ...
            <div className="col-md-8">
              <div className="p-3 py-5">
                ...
                <div className="mt-5 text-right">
                  <button className="ProfileButt" type="submit" value="Submit">
