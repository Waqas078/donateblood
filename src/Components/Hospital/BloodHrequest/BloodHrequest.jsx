...
import { bloodRequest, getProfileData } from "../../../api";
function Donate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log({ group, city, address, number, reason, emergency, description });
      const { data } = await bloodRequest({ group, city, address, number, reason, emergency, description});
      console.log(data);
    } catch (error) {
      console.log(error);
    }
                    ...
                    <Form onSubmit={handleSubmit} >
                      ...
                      <div class="row">
                        {/* <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="date" required value={date} onChange={(e) => setDate(e.target.value)}/>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <span class="form-label">Required Time</span>
                            <input class="form-control" type="time" required value={time} onChange={(e) => setTime(e.target.value)} />
                          </div>
                        </div> */}
                        <div class="col-md-3">
                          <div class="form-group">
                      ...
                      <div class="row"> */}
                        <div class="col-md-3">
                          ...
                          <div className="formm" value={emergency} onChange={(e) => setEmergency(e.target.value)}>
                            <label className="labeel">
                              <input
                                className="check"
                                value='No'
