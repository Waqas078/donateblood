...
import { hospitalRequestsData } from "../../../api/index";

// import "./DonateForm.css";
function DonateHospital() {
  const [allData, setallData] = useState([]);
  const fetchallData = async () => {
    const { data } = await hospitalRequestsData();
    console.log(data);
    setallData(data);
  };
  useEffect(() => {
          ...
          <div class="booking-form">
            <form>
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <span class="form-label">Select Hospitals</span>
                    <select class="form-control">
                      <option>Select....</option>
                      <option>Rawalpindi</option>
                      <option>Rawalpindi</option>
